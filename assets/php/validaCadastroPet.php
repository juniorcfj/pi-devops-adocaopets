...
function cadastrarPet($dono, $nome, $especie, $sexo, $idade, $porte, $estado, $cidade, $adotado, $foto)
{
   ...
   $sql = "INSERT INTO cadastropet (dono, nome, especie, sexo, idade, porte, estado, cidade, adotado, foto) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
$stmt->bind_param("ssssssssis", $dono, $nome, $especie, $sexo, $idade, $porte, $estado, $cidade, $adotado, $fotoCaminho);
    if ($stmt->execute()) {
